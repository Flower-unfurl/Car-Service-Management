            ...
            <div className="flex w-full max-w-[1100px] h-[700px] bg-white shadow-2xl overflow-hidden rounded-2xl">
                ...
                <div className="hidden md:flex md:w-1/2 relative">
                    ...
                    <div className="absolute inset-0 bg-[#1e5aa0]/80 flex flex-col justify-center px-12 text-white">
                        <h2 className="text-3xl font-bold uppercase tracking-wider mb-4">AutoRepair Portal</h2>
                ...
                <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-12 bg-white">
                    <div className="w-full max-w-md">
                        <h1 className="text-2xl font-bold text-center text-gray-800 uppercase mb-2">Sign In To Car-Service</h1>
                        ...
                        <p className="mt-10 text-center text-sm text-gray-600">
                            Don't have an account? <a href="/signup" className="text-[#1e5aa0] font-bold hover:underline">Sign up</a>
                        </p>
                    </div>
                </div>
