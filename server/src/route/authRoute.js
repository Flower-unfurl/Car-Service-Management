...
authRoute.post("/request-otp", async (req, res, next) => {
    try {
...
authRoute.post("/logout", authToken, async (req, res, next) => {
    try {
...
authRoute.post("/request-reset-otp", async (req, res, next) => {
    try {
...
authRoute.post("/verify-reset-otp", async (req, res, next) => {
    try {
...
authRoute.get("/me", async (req, res, next) => {
    try {
